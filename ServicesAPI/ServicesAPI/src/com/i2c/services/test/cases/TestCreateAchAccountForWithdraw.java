...
public class TestCreateAchAccountForWithdraw extends BaseTestCase {
    ...
    public void performTest(ServicesRequestObj requestObj) {
        try {
            ...
            respObj = ServicesHandler.getInstance(connection,
                    reader.getLogPath()).createACHAccountForWithdraw(requestObj);
            // assert
            assertEquals("TestCreateAchAccountForLoad::Ach Type is not 2", "2",
