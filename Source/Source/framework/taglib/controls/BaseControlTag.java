...
public abstract class BaseControlTag extends TagSupport
{
	...
	protected String  onSubmit;
		 ...
		 * @throws Exception
		 */
		public Object getOBJValue(String valueName , String value) throws Exception{
			Object obj =null;
			if(valueName!=null && value!=null){
				try{
					obj= this.pageContext.getSession().getAttribute(valueName);
				obj	=obj.getClass().getMethod(value,null).invoke(obj,null);
				}catch(Exception exp)
				{
					exp.printStackTrace();
				}
		...
		public java.util.Vector getOBJValue(String listName , String value , boolean mRows_And_Column) throws Exception{
			Vector data=null;
			Object obj =null;
			List list=null;
