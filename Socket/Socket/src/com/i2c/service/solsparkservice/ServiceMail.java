...
public class ServiceMail {
  ...
  public void setFileTitle( String s ) { titleFile=s; }
  public void setSMTPServer( String s ) { smtpServer=s; }
  public void setRecipientsTO ( String[] s) { recipientsTO = s; }
  public void setRecipientsCC ( String[] s ) { recipientsCC = s ; }
  public void setRecipientsBCC ( String[] s ) { recipientsBCC = s ; }
  ...
  public void postMail() throws MessagingException {
    ...
    PrintWriter writer = new PrintWriter(new FileWriter("mail.log",false),true);
   ...
   props.put("mail.smtp.host", smtpServer);
    ...
    writer.println ("SMTP Server : " + smtpServer);
    ...
    if (recipientsCC != null && recipientsCC.length > 0) {
            ...
            for (int i = 0; i < recipientsCC.length; i++)
            {
                addressCC[i] = new InternetAddress(recipientsCC[i]);
                    writer.println("CC addresse# + " + i + "  : " + addressCC[i] ) ;
        ...
        if (recipientsBCC != null && recipientsBCC.length > 0) {
            ...
            for (int i = 0; i < recipientsBCC.length; i++)
            {
                addressBCC[i] = new InternetAddress(recipientsBCC[i]);
                    writer.println("BCC addresse# + " + i + "  : " + addressBCC[i] ) ;
      ...
      String FullFileName = "";
        ...
        if (fileName != null) {
          ...
          for (int i = 0; i < fileName.length; ++i) {
            ...
            titleFileName = Constants.REPORT_FILE_TITLE+" "+getFileTitle(FullFileName);
  ...
  public String getFileTitle(String value) {
    try {
      CommonUtilities.getLogger().log(LogLevel.getLevel(Constants.LOG_FINEST)," File Title to be get --->"+value);
      ...
      CommonUtilities.getLogger().log(LogLevel.getLevel(Constants.LOG_FINEST),"Final File Title --->"+value);
    } catch (Exception e){
      CommonUtilities.getLogger().log(LogLevel.getLevel(Constants.LOG_WARNING)," Exception in Getting File Title -->"+value);
    }//end catch
    return value;
  }//end get file title
