...
public class Constants {
  ...
  public static DbConnectionInfoObj CARD_INSTANCE_DB_CONN = null;

  public static String SIGMA_EXPORT_PATH = "";
  public static String SIGMA_EXPORT_FILE = "";
  public static String EXPORTED_FOLDER = "Exported";
  public static String FTP_DOWNLOAD_PATH = "D:\\";
//  public static String FTP_DOWNLOAD_FOLDER ="billersList\\downLoad\\";
//    public static String FTP_DOWNLOAD_FOLDER ="Haroon\\BillPayment\\Response_Files\\mcp\\Download\\";
//  public static String FTP_UPLOAD_FOLDER = "Haroon\\BillPayment\\Payment_Files\\mcp\\Upload\\";
  public static String RESPONSE_FTP_DOWNLOAD_FOLDER ="";
  public static String ADJUSTMENT_FTP_DOWNLOAD_FOLDER ="";
  public static String PAYEE_FTP_DOWNLOAD_FOLDER = "";
  public static String FTP_UPLOAD_FOLDER = "";
  public static String FTP_DOWNLOAD_FOLDER = "";

  /********************* BPayment  **************/
  public static String PROCESSOR_ID = "1"; //-- Processor ID
//  public static String RESADJ_NO_OF_DAYS = "7"; //-- No of Days for which to Process Response and Adjustment
  public static final int RSP_FILE_ID = 11;
  public static final int ADJ_FILE_ID = 12;
  public static final int PMT_FILE_ID = 13;
  public static final int PYE_FILE_ID = 14;
  /*************************************************/
  ...
  public static String PAYMENT_SERVICE_MONITOR_SERVICE="payment_service_monitor";
  public static String PAYMENT_SERVICE="payment_service";
  public static String RESPONSE_SERVICE_MONITOR_SERVICE="response_service_monitor";
  public static String RESPONSE_SERVICE="response_service";
  public static String ADJUSTMENT_SERVICE_MONITOR_SERVICE="adjustment_service_monitor";
  public static String ADJUSTMENT_SERVICE="adjustment_service";
  ...
  public static String[] APPLICATIONS_NAME_ARRAY = {
      //ACH_LOAD_BATCH_MONITOR_SERVICE,
      //ACH_BATCH_CONFIG_SERVICE,
      PAYMENT_SERVICE_MONITOR_SERVICE,
      PAYMENT_SERVICE,
      RESPONSE_SERVICE_MONITOR_SERVICE,
      RESPONSE_SERVICE,
      ADJUSTMENT_SERVICE_MONITOR_SERVICE,
      ADJUSTMENT_SERVICE,
      PAYEE_SERVICE_MONITOR_SERVICE,
      PAYEE_SERVICE};
...
//----------------Batch File Related Attributes-----------//
  ...
  public static String PAYMENT_SRV = "PAYMENT_SRV";
  public static String PAYMENT_SRV_FAIL = "PAYMENT_SRV_FAIL";
  public static String PAYMENT_SRV_SUCC = "PAYMENT_SRV_SUCC";
  public static String RESPONSE_SRV = "RESPONSE_SRV";
  public static String RESPONSE_SRV_FAIL = "RESPONSE_SRV_FAIL";
  public static String RESPONSE_SRV_SUCC = "RESPONSE_SRV_SUCC";
  public static String RESPONSE_DOWNLOAD_FAIL = "RESPONSE_DL_FAIL";
  public static String RESPONSE_INFILE_FAIL = "RESPONSE_INFILE_FAIL";
  public static String ADJUSTMENT_SRV = "ADJUSTMENT_SRV";
  public static String ADJUSTMENT_SRV_FAIL = "ADJUSTMENT_SRV_FAIL";
  public static String ADJUSTMENT_SRV_SUCC = "ADJUSTMENT_SRV_SUCC";
  public static String ADJUSTMENT_DOWNLOAD_FAIL = "ADJUSTMENT_DL_FAIL";
  public static String ADJUST_INFILE_FAIL = "ADJUST_INFILE_FAIL";
  ...
  public static String SENT_PAYMENT_FILE_STATUS = "S";
...
// -------------Scheduler Attributes-------------
  ...
  public static String USE_BILL_PAYMENT_PAYEE_PROCESSING="USE_BILL_PAYMENT_PAYEE_PROCESSING";
  public static String USE_BILL_PAYMENT_PROCESSING="USE_BILL_PAYMENT_PROCESSING";
  public static String USE_BILL_RESPONSE_PROCESSING="USE_BILL_RESPONSE_PROCESSING";
  public static String USE_BILL_ADJUSTMENT_PROCESSING="USE_BILL_ADJUSTMENT_PROCESSING";
...
//  public static String INT_FIS_LOG_FOLDER="int_fis_service";
  ...
  public static String RESPONSE_SRV_LOG_FOLDER="services_";
  // Output path for CHAuthService
  ...
  public static String ENCRYPT_FOLDER = "Encrypt";
  public static String DECRYPT_FOLDER = "Decrypt";

  public static String PAYEE_OUTPUT_PATH = null;
  public static String PAYMENT_OUTPUT_PATH = null;
  public static String RESPONSE_OUTPUT_PATH = null;
  public static String ADJUSTMENT_OUTPUT_PATH = null;
  public static String VERIFY_PUBLIC_KEY_PATH = null;
  public static String ENCRYPT_PUBLIC_KEY_PATH = null;
  public static String SECRET_KEY_PATH = null;
  public static String PASS_PHRASE = null;
  public static String RESPONSE_INFILE_PREFIX = null;
  public static String ADJUSTMENT_INFILE_PREFIX = null;
  public static String RES_DECRYPT_INFILE_NAME = null;
  public static String ADJ_DECRYPT_INFILE_NAME = null;
...
//--------------CHAuthService Active Threads----------------------//
  ...
  public static long DEFAULT_WAIT_TIME = 3600000;
  public static long DEFAULT_SLEEP_TIME = 60000;
  public static long PAYEE_SLEEP_TIME = 60000;
  public static long PAYMENT_SLEEP_TIME = 60000;
  public static long RESPONSE_SLEEP_TIME = 60000;
  public static long ADJUSTMENT_SLEEP_TIME = 60000;
  ...
  public static String ALERT_EMAIL_MSG = "# Bill Payment Monitor Thread has detected some problem in the execution of # at <#> instance. The # is not responding since # minutes.";
  public static String ALERT_EMAIL_SUBJECT = "MCP Bill Payment Scheduler Service Monitoring Alert";
  public static long DEFAULT_ALERT_TIME = 60;
  public static long MONITOR_SERVICE_SLEEP_TIME = 60;
  //***************************************************************//

//  public static String ALERT_EMAIL_HDR = "Dear Administrator,";
//  public static String ALERT_EMAIL_MSG = "# Bill Payment Monitor Thread has detected some problem in the execution of # at <#> instance. The # is not responding since # minutes.";
  public static String RESADJ_FAIL_EMAIL_SUBJECT = "MCP Bill Payment Scheduler Service Monitoring Alert";
//  public static long DEFAULT_ALERT_TIME = 60;
//  public static long MONITOR_SERVICE_SLEEP_TIME = 60;
  //***************************************************************//
...
//  }//end methid
  ...
  /*------------- Primary Schdeduler Data------------------*/
  public static String SCHEDULER_TYPE = "P";
  public static String SCHEDULER_IP = null;
  public static int SCHEDULER_PORT = -1;
 ...
 //-----------------------------------------------------//
  ...
  public static synchronized void setMachineIP() {
    try {
      ServiceMain.lgr.log(LogLevel.getLevel(Constants.LOG_INFO),
