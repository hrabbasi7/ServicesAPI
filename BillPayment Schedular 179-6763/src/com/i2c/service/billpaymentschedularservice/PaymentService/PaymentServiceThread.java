...
import com.i2c.service.billpaymentschedularservice.monitor.PaymentServiceMonitor;
import com.i2c.service.util.*;
import org.bouncycastle.openpgp.service.PGPCryptographicService;
...
//      if (BillPaymentProcessor.filsStatsObj.isFileCreated()) {
      ...
      /*********Get File from DB ********************/
      pmtFileAList = CommonUtilities.getFileFromDB(dbConn,
                                    BillPaymentProcessor.filsStatsObj.getFileName(),
                                    uploadPath.toString() + File.separator +
                                    BillPaymentProcessor.filsStatsObj.getFileName());
