    ...
    try {
      ...
      while (true) {
        ...
        try {
          ...
          if ((payeeServiceDAO.processScheduler(dbConn, Constants.USE_BILL_PAYMENT_PAYEE_PROCESSING))
...
//                  continue;
  ...
  public StringBuffer invokePayeeProcessing(Connection dbConn,
    ...
    try {
      ...
      if (((Constants.PAYEE_OUTPUT_PATH != null) &&
        ...
        downloadFolderPath = ouputPath.toString();
...
//                     payeeFileName);
      ...
      PayeePopulator(connClientInst, logPath, ouputPath);
...
//  public void PayeePopulator(Connection dbConn,
//                              PayeeServiceDAO payeeDao,
//                              StringBuffer logPath,
//                              StringBuffer ouputPath,
//                              String movePath,
...
//                              ) throws Exception {
    ...
    public void PayeePopulator(Connection dbConn,
                             StringBuffer logPath,
                             StringBuffer ouputPath) throws Exception {
...
//    }
    ...
    PayeeMapper mapper = new PayeeMapper(instanceName,
                                         dbConn,
                                         logPath.toString() + File.separator + "PayeeAPI",
                                         ouputPath.toString(),
                                         payeeApiLogger);
