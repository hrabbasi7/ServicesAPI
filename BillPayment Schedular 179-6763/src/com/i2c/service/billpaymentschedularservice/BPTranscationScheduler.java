...
import com.i2c.service.billpaymentschedularservice.ResponseService.ResponseServiceDAO;
...
import java.sql.*;
import com.i2c.service.billpaymentschedularservice.FTPService.FTPUtil;
...
public class BPTranscationScheduler extends Thread {
  ...
  private void processRespAdj(String instanceName,
                              ...
                              PaymentServiceMonitor paymentServiceMonitor)
      throws Exception {
    ...
    while (responseDone == false || adjustmentDone == false) {
      ...
      // if Response or Adjustment not processed then Sleep Else no sleep
      if (responseDone == false || adjustmentDone == false){
