...
class AdjustmentServiceMailer {
  ...
  AdjustmentServiceMailer(String emailID, String instanceName, String machineIP, Logger lgr) {
  ...
  AdjustmentServiceMailer(String emailID, String instanceName, String machineIP,
