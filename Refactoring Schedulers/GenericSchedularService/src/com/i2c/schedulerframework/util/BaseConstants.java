...
public class BaseConstants {
  ...
  public static DbConfigBean CARD_INSTANCE_DB_CONN = null;

  public static String COMMON_LOG_INFO = "common";

  public static String CARDS_PATH = "./mcp";

  public static String SCHEDULER_ID = null;
  ...
  public static String MONTH_DAY_YEAR_TIME_FORMAT = "MM-dd-yyyy hh:mm:ss";
  ...
  public static String MODULE_CONFIGURATION_FILE = null;
  public static String COMMON_CONFIGURATION_FILE = null;

  //--------------Varibles for the Loggging --------------------//
  public static String LOG_FILE_PATH = "";
  public static String LOG_FILE_NAME = "";
  public static String LOG_CONTEXT_NAME = "com.i2c.schedulerframework";
  ...
  //--------------- BL Derviced Class Name --------com.i2c.GSFW.bl.BLDerived-----//

  public static String BL_DERIVED_CLASS_NAME = "";
