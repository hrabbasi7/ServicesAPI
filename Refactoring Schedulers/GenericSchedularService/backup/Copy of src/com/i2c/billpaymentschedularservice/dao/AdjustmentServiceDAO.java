...
public class AdjustmentServiceDAO extends BaseHome{

  private String instanceID = null;
  private Connection dbConn = null;
  private Logger lgr = null;

  public AdjustmentServiceDAO(String instanceID, Connection dbConn, Logger lgr) {
   ...
   *
   */
  public FTPInfoVO getAdjustmentFtpInfo() {
    boolean schTime = false;
...
//      System.out.print("getResponseFtpInfo---->" + query.toString());
   ...
   * @return boolean
   */
  public boolean adjustmentSleepTime(String processor_id) {
      boolean schTime = false;
  ...
  public ArrayList getOldAdjustmentFileDateFtp() {
    ...
    try {
      ...
      while (rs.next()) {
        if (rs.getString(1) != null && rs.getString(1).trim().length() > 0) {
          adjDate = CommonUtilities.convertDateFormat(Constants.DATE_FORMAT,
