...
public class PayeeServiceMonitor
    extends Thread {
  ...
  public PayeeServiceMonitor(String instanceName,
                             String serviceName,
                             Logger lgr) {
  ...
  public void run() {
    ...
    lgr.log(
        ...
        " Payee Service Monitor Service Thread is Started --- Instance Name-->" +
      ...
      try {
        ...
        if (alertMessage != null) {
          ...
          lgr.log(LogLevel.getLevel(Constants.LOG_FINEST),
                  " Payee Service Monitor Service Thread detected problem in the execution of Payee Service Thread for instance --->" +
                  instanceName +
          ...
          lgr.log(LogLevel.getLevel(Constants.LOG_FINEST),
                  " Payee Service Monitor Service Thread detected no problem in the execution of Payee Service Thread for instance --->" +
                  instanceName +
        ...
        lgr.log(LogLevel.getLevel(Constants.LOG_WARNING),
                " Exception in Payee Service Monitor Service Thread --->" + ex);
      }
      catch (Throwable th) {
        System.out.println(
