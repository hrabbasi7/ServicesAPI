...
public class ResponseServiceMailer {
  ...
  public ResponseServiceMailer(String emailID, String instanceName, String machineIP, Logger lgr) {
  ...
  public ResponseServiceMailer(String emailID, String instanceName, String machineIP,
