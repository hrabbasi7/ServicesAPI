...
public class StatusInformerSocket extends Thread
{
  ...
  public void run()
  {
    localLogr.log(I2cLogger.FINEST," StatusInformerSocket ---- run---- ");
    ...
    try
    {
      while (true)
      {
        ...
        {
          localLogr.log(I2cLogger.SEVERE,"Exception in creating connection with client---> " + ex);
        }
        finally
        {
            try
            ...
            {
              localLogr.log(I2cLogger.WARNING,"Client already closed---> " + ex2);
            }
        }// end finally
      }// end while
    }// end outer try
    ...
    {
      localLogr.log(I2cLogger.SEVERE,"Exception in creating listening to vlient requests---> " + ex1);
    }
    finally
    {
      try
      ...
      {
        localLogr.log(I2cLogger.WARNING,"Exception in closing server---> " + ex3);
      }
