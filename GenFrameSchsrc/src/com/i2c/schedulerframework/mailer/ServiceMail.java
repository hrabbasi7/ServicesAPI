...
public class ServiceMail extends Thread {
  ...
  public void run() {
          try {
              System.out.println("[ServiceMail].[run] --- run method for sending email...");
              postMail();
          } catch (MessagingException msgEx) {
              System.err.println("[ServiceMail].[run] --- Messageing exception in sending email--->" +
                      msgEx);
          } catch (Exception ex) {
              System.err.println("[ServiceMail].[run] --- Exception in sending email--->" +
                      ex);
          }
    }
